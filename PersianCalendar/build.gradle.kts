import io.github.persiancalendar.gradle.GenerateAppSrcTask
...
val generateAppSrcTask by tasks.registering {
    ...
    doLast {
        generateDir.mkdirs()
        GenerateAppSrcTask.generateEventsCode(eventsJson, eventsOutput)
        GenerateAppSrcTask.generateCitiesCode(eventsJson, eventsOutput)
        GenerateAppSrcTask.generateDistrictsCode(eventsJson, eventsOutput)
    }
}
